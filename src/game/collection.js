...
export const HINTS = {
  ...
  frostflower: 'Im Winter am Boden, überall wo etwas wächst.',
  wreath_spring: 'Werkbank – aus Blütenblättern. Nur im Frühling.',
  wreath_summer: 'Werkbank – aus Sonnensteinen. Nur im Sommer.',
  wreath_autumn: 'Werkbank – aus Ahornblättern. Nur im Herbst.',
  wreath_winter: 'Werkbank – aus Eisblumen. Nur im Winter.',
  bench: 'Werkbank.',
  fence: 'Werkbank.',
  flowerbed: 'Werkbank.',
  birdhouse: 'Werkbank.',
